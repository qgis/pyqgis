...
QGIS supports plugins to do things like display tracks from your GPS. QGIS is Open Source software and its free of cost (`download here <https://www.qgis.org/en/site/forusers/download.html>`_).
