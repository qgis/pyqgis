...
parser.add_argument('--package', '-p', dest='package_limit', default=None, nargs='+',
                    choices=['utils', 'core', 'gui', 'server', 'analysis', 'processing', '3d'],
...
if args.package_limit:
    ...
    from qgis import core, gui, analysis, server, processing, _3d, utils
    packages = {'utils': utils, 'core': core, 'gui': gui, 'analysis': analysis, 'server': server, 'processing': processing, '3d': _3d}
